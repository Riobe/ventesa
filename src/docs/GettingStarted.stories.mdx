...
`<project-directory>/src/web/components`:  
...
`<project-directory>/src/web/theme`:  
...
`<project-directory>/src/native`:  
The main process code from electron, that runs outside of Chrome and can do anything node can do is in this folder.
